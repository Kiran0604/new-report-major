...
\begin{figure}[H]
    ...
    \includegraphics[width=0.9\textwidth]{Figures/Plaga.png}
...
The paper titled "Mitigating Logistics Friction in Global Chokepoints: An Agentic AI Framework for Indian Export-Import Resilience" has been drafted. It will be submitted for publication in a International Journal or Conference.

\begin{figure}[H]
    \centering
    % Placeholder for plagiarism report screenshot/scan
    \includegraphics[width=0.8\textwidth]{Figures/paper.png}
    \label{fig:submission_details}
\end{figure}
