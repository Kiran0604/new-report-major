...
\begin{tikzpicture}[scale=0.85, transform shape, node distance=1.1cm, every node/.style={align=center, font=\small},
    startstop/.style={rectangle, rounded corners=8pt, minimum width=3.5cm, minimum height=0.8cm, draw=black!80, fill=blue!20},
    process/.style={rectangle, minimum width=4.5cm, minimum height=0.8cm, draw=black!80, fill=yellow!20},
    decision/.style={diamond, aspect=2.5, minimum width=4cm, minimum height=0.8cm, draw=black!80, fill=orange!20},
    arrow/.style={->, thick}]
