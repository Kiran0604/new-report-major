\documentclass[12pt,twoside,a4paper,openany]{book} % This style for A4 format.
...
\guideDesignationA{Professor and Program Coordinator}
...
\panelMemberDeptA[CSE]{Computer Science and Engineering (Data Science)}
...
% Added Ver 3.6 & 3.9
\projectCoOrdNameB{Dr. Chethana Murthy}
\projectCoOrdDesigB{Associate Professor and Program Coordinator}
\projectCoOrdDeptB[CSE]{Computer Science and Engineering}
% Not used for IDP and Internship
\projectCoOrdNameA{Dr. Sindhu D V}
\projectCoOrdDesigA{Assistant Professor and Program Coordinator}
