...
These contributions are aligned with broader reviews of agentic AI that emphasise autonomy, adaptability, tool use, and multi-step goal pursuit as defining paradigm properties \cite{HosseiniSeilani2025}. Comprehensive surveys of agentic system architecture have further corroborated these properties as essential characteristics of goal-oriented autonomous design \cite{HughesEtAl2025}. It is thus established in the literature that agentic AI has moved beyond conceptual framing to serve as a practical design pattern for forecasting, interaction, and operational decision support in supply chains.
...
Across these streams, the literature has moved from predictive analytics and digital visibility toward agentic autonomy, multi-agent coordination, and prescriptive action. The strongest recent contributions show that autonomous systems can monitor disruptions and reason over text and network structure \cite{AlMahriEtAl2026}. Complementary reviews have validated these capabilities across multiple supply chain application domains \cite{QuHuIvanov2026}. Agentic designs have further been shown to support sustainability-oriented decisions \cite{Tathavadekar2025}, including explicit optimisation of cost and emissions in logistics workflows \cite{Aylak2025}. However, the established literature also demonstrates that most existing work remains either sector-specific \cite{Tiwari2025} or simulation-oriented \cite{Kalisetty2024}, rather than providing end-to-end autonomous execution in real operational contexts \cite{XuEtAl2024}. Broader reviews have similarly noted that enabling technologies are well-studied while integrated execution frameworks remain absent \cite{White2026}.

The most important unresolved gap identified is the absence of a unified framework that combines agentic reasoning, disruption intelligence, explainability, and one-click operational execution for resource-constrained and volatility-prone contexts. This gap is especially visible in maritime and SME-oriented environments, where disruption originates deep in the network and data are sparse \cite{Thompson2024}. The structural complexity of maritime information ecosystems further compounds these challenges \cite{ChenPatel2026}. Compliance burdens additionally constrain the design space in cross-border logistics contexts \cite{Hernandez2025}, and response latency remains a critical performance threshold for SME resilience \cite{Murthy2023}. The present project therefore sits at the intersection of agentic AI, resilience analytics, and autonomous supply chain governance, with the primary goal of moving from detection to mitigation in a single operational loop.
