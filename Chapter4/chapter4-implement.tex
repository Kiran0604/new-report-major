...
\subsection[Functional Module Descriptions]{Functional Module Descriptions}
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{Figures/DFD0.png}}
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.26\textwidth]{Figures/DFD1.png}}
...
\begin{figure}[htbp]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.26\textwidth]{Figures/DFD2.png}}
